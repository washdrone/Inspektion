...
export function BenefitsGrid({ headline, subtitle, benefits }: BenefitsGridProps) {
  return (
      ...
      <div className="container-content">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit, i) => (
            <div key={i} className="rounded-xl border border-neutral-200 bg-white p-6 transition-shadow hover:shadow-md">
