    ...
    >
      <nav className="container-content flex h-20 items-center justify-between" aria-label={isEn ? 'Main navigation' : 'Huvudnavigering'}>
        ...
        <div className="hidden items-center gap-1 lg:flex">
          ...
          <Link href={isEn ? '/en/knowledge-base' : '/kunskapsbank'} className="rounded-pill px-4 py-2 text-sm font-medium text-white/80 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400 focus-visible:ring-offset-2 focus-visible:ring-offset-dark-900">
            {isEn ? 'Knowledge Base' : 'Kunskapsbank'}
          </Link>
      ...
      >
        <div className="container-content space-y-1 py-6">
          ...
          <div className="border-t border-white/10 pt-3 mt-3">
            ...
            <Link href={isEn ? '/en/knowledge-base' : '/kunskapsbank'} className="block rounded-xl px-4 py-3 text-base font-medium text-white/90 hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-accent-400 focus-visible:ring-offset-2 focus-visible:ring-offset-dark-900 focus-visible:outline-none" onClick={() => setMobileMenuOpen(false)}>{isEn ? 'Knowledge Base' : 'Kunskapsbank'}</Link>
