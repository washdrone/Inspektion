...
import { INSPECTION_LINKS, COMPANY_LINKS, REGION_LINKS, CONTACT } from '@/lib/constants'
        ...
        <div className="grid gap-10 md:grid-cols-5">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-dark-400">
              Professionell drönare-inspektion med termisk kamera i hela Sverige. Tak, fasader, solceller och industri. EASA-certifierade piloter.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2.5 text-sm text-dark-300">
              ...
              <p className="text-dark-400">Hela Sverige</p>
            </div>
          </div>
        </div>
